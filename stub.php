<?php
// https://github.com/phpredis/phpredis/blob/0059e77fe5491ed2da00ca181138f643b95fb4cb/redis.stub.php
...
class RedisStub
{
    ...
    public function georadius(string $key,
        float $lng,
        float $lat,
        float $radius,
        string $unit,
        array $options = []) : array{}
    public function georadius_ro(string $key,
        float $lng,
        float $lat,
        float $radius,
        string $unit,
        array $options = []) : array{}
    public function georadiusbymember(string $key,
        string $member,
        float $radius,
        string $unit,
        array $options = []) : array{}
    public function georadiusbymember_ro(string $key,
        string $member,
        float $radius,
        string $unit,
        array $options = []) : array{}
    public function geosearch(string $key,
        array|string $position,
        array|int|float $shape,
        string $unit,
        array $options = []) : array{}
    public function geosearchstore(string $dst,
        string $src,
        array|string $position,
        array|int|float $shape,
        string $unit,
     ...
     */
    public function popen(string $host,
        int $port = 6379,
        float $timeout = 0,
        string $persistent_id = null,
        int $retry_interval = 0,
    ...
    public function xclaim(string $key,
        string $group,
        string $consumer,
        int $min_iddle,
        array $ids,
        array $options) : string|array{}
    public function xdel(string $key, array $ids) : int{}
    public function xgroup(string $operation,
        string $key = null,
        string $arg1 = null,
        string $arg2 = null,
        bool $arg3 = false) : mixed{}
    public function xinfo(string $operation, string $arg1 = null, string $arg2 = null) : mixed{}
    public function xlen(string $key) : int{}
    public function xpending(string $key,
        string $group,
        string $start = null,
        string $end = null,
        int $count = -1,
        string $consumer = null) : string{}
    ...
    public function xreadgroup(string $group,
        string $consumer,
        array $streams,
        int $count = 1,
        int $block = 1) : bool|array{}
